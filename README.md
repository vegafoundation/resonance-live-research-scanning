...
This repository contains the conceptual definition and theoretical framework for **Live Research Scanning**, 
...
├── LICENSE             # CC BY 4.0
├── paper/
│   └── live-research-scanning.tex    # LaTeX dissertation
├── whitepaper/
│   └── live-research-scanning.md     # White paper
└── translations/
    ├── de/             # German
    ├── en/             # English
    ├── tr/             # Turkish
...
```bibtex
@misc{vega2025liveresearchscanning,
  author = {Vega, Adam Eren},
  title = {Live Research Scanning: A Conceptual Framework},
  year = {2025},
  publisher = {GitHub},
  url = {https://github.com/vegafoundation/live-research-scanning}
}
```
